...
while this == True :
    ...
    def fin_screen() :#ecran avec 2 optio apres mourir dans le jeu
        pygame.mixer.music.stop()
        pygame.mixer.music.load(MUSIC_FIN)
        pygame.mixer.music.play(-1)
        pygame.display.set_caption("fin")
        #BG = pygame.display.set_mode(width, height)
        Fin = pygame.image.load(FIN)
        Fin = pygame.transform.scale(Fin, (1920, 1080))
        ...
        while fin == True :
            ...
            for event in pygame.event.get():#quit
                ...
                if event.type == pygame.MOUSEBUTTONDOWN: 
                    print(Position_souris)
                    if 727 < Position_souris[0] < 1236 and  883 < Position_souris[1] <  1069:
                        return True   
            pygame.display.flip()
    ...
    def cinematique() :
        ...
        images = ['Cinematique_1.png', 'Cinematique_2.png', 'Cinematique_3.png', 'Cinematique_4.png', 'Cinematique_5.png', 'Cinematique_6.png', 'Cinematique_7.png',
                'Cinematique_8.png', 'Cinematique_9.png', 'Cinematique_10.png', 'Cinematique_11.png', 'Cinematique_12.png', 'Cinematique_13.png', 'Cinematique_14.png',
                'Cinematique_15.png', 'Cinematique_16.png', 'Cinematique_17.png', 'Cinematique_18.png', 'Cinematique_19.png', 'Cinematique_20.png', 'Cinematique_21.png',
                'Cinematique_22.png', 'Cinematique_23.png', 'Cinematique_24.png', 'Cinematique_25.png']
        clock.tick(1)
        for image in images:
